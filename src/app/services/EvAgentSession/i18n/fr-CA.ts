...
export default {
  ...
  [loginTypes.integrated]: 'Téléphone logiciel intégré',
  [dropDownOptions.None]: 'Aucun',
  [messageTypes.NOT_INBOUND_QUEUE_SELECTED]: 'Veuillez sélectionner au moins une file d\'attente entrante ou un groupe de numérotation.',
